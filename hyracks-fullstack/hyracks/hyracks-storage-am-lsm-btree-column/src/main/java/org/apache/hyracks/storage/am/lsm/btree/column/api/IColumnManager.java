...
public interface IColumnManager {
     ...
     */
    IColumnMetadata createMergeColumnMetadata(IValueReference metadata,
            List<AbstractColumnTupleReference> componentsTuples) throws HyracksDataException;
     ...
     */
    IColumnProjectionInfoProvider getMergeColumnProjectionProvider();
}
