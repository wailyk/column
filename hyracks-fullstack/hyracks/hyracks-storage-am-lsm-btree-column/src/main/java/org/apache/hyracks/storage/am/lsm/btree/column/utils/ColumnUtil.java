...
import org.apache.hyracks.storage.am.lsm.btree.column.api.projection.IColumnProjectionInfoProvider;
...
public class ColumnUtil {
    ...
    public static IValueReference getColumnMetadataCopy(IComponentMetadata metadata) throws HyracksDataException {
        ArrayBackedValueStorage storage = new ArrayBackedValueStorage();
        metadata.get(COLUMNS_METADATA_KEY, storage);
        return storage;
    }
    ...
    public static IColumnProjectionInfoProvider getColumnProjectionInfoProvider(IIndexAccessParameters iap,
            IColumnProjectionInfoProvider defaultProjectionInfoProvider) {
        IColumnProjectionInfoProvider projectionInfoProvider =
                iap.getParameter(HyracksConstants.PROJECTION_INFO_PROVIDER, IColumnProjectionInfoProvider.class);
        return projectionInfoProvider == null ? defaultProjectionInfoProvider : projectionInfoProvider;
    }
}
