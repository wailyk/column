...
public final class ColumnBTreeReadLeafFrame extends AbstractColumnBTreeLeafFrame {
    ...
    public AbstractColumnTupleReference createTupleReference(int index, IColumnReadMultiPageOp multiPageOp) {
        return columnarTupleReader.createTupleReference(this, index, multiPageOp);
    }
