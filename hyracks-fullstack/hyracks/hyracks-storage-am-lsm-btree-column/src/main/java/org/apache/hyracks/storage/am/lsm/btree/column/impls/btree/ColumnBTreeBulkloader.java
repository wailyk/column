...
public final class ColumnBTreeBulkloader extends BTreeNSMBulkLoader implements IColumnWriteMultiPageOp {
    ...
    private int numberOfPersistentBuffers;
    ...
    protected void writeFullLeafPage() throws HyracksDataException {
        ...
        if (tupleCount > 0) {
            //We need to flush columns first to confiscate all columns pages first before calling propagateBulk
            columnarFrame.flush(columnWriter, tupleCount, this, lowKey.getTuple(), splitKey.getTuple());
        }
        ...
        /*
         * Write columns' pages first to ensure they (columns' pages) are written first before page 0
         * It is not a matter of correctness but to ensure page 0 does not land in between columns' pages if
    ...
    protected void writeLastLeaf(ICachedPage page) throws HyracksDataException {
        /*
         * Write columns' pages first to ensure they (columns' pages) are written first before page 0
         * It is not a matter of correctness but to ensure page 0 does not land in between column pages if
         * compression is enabled.
         */
        writeColumnsPages();
    ...
    public int getNumberOfPersistentBuffers() {
        return numberOfPersistentBuffers;
    }
