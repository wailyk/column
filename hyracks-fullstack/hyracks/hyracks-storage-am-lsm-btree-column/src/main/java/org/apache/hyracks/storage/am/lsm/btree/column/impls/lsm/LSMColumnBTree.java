...
public class LSMColumnBTree extends LSMBTree {
    ...
    public void search(ILSMIndexOperationContext ictx, IIndexCursor cursor, ISearchPredicate pred)
        ...
        LSMColumnBTreeOpContext ctx = (LSMColumnBTreeOpContext) ictx;
    ...
    public LSMColumnBTreeOpContext createOpContext(IIndexAccessParameters iap) {
        ...
        IColumnProjectionInfoProvider projectionInfoProvider =
                ColumnUtil.getColumnProjectionInfoProvider(iap, columnManager.getMergeColumnProjectionProvider());
        return new LSMColumnBTreeOpContext(this, memoryComponents, insertLeafFrameFactory, deleteLeafFrameFactory,
                ...
                getHarness(), getFilterCmpFactories(), tracer, projectionInfoProvider);
    }
