...
public class ArrayTupleBuilder implements IDataOutputProvider {
     ...
     *
     * @param accessor - Frame that contains the field to be copied into the tuple
     *                 builder.
     * @param tIndex   - Tuple index of the tuple that contains the field to be
     *                 copied.
     * @param fIndex   - Field index of the field to be copied.
     ...
     *
     * @param accessor - Tuple that contains the field to be copied into the tuple
     *                 builder.
     * @param fIndex   - Field index of the field to be copied.
     * @throws HyracksDataException
     */
     ...
     *
     * @param bytes  - Byte array to copy the field data from.
     * @param start  - Start offset of the field to be copied in the byte array.
     * @param length - Length of the field to be copied.
     * @throws HyracksDataException
     */
