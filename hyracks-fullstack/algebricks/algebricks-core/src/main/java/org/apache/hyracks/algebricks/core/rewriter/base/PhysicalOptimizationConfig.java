...
public class PhysicalOptimizationConfig {
    ...
    private static final String CODE_GEN = "CODE_GEN";
    ...
    public boolean isCodeGen() {
        return getBoolean(CODE_GEN, AlgebricksConfig.CODE_GEN_DEFAULT);
    }

    public void setCodeGenEnabled(boolean codeGen) {
        setBoolean(CODE_GEN, codeGen);
    }
