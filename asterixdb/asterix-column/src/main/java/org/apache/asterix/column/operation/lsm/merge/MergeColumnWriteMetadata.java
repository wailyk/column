...
public final class MergeColumnWriteMetadata extends AbstractColumnImmutableMetadata {
    ...
    private final List<AbstractColumnTupleReference> componentsTuples;
    ...
    private MergeColumnWriteMetadata(ARecordType datasetType, ARecordType metaType, int numberOfPrimaryKeys,
            ...
            IValueReference serializedMetadata, List<AbstractColumnTupleReference> componentsTuples) {
    ...
    public static MergeColumnWriteMetadata create(ARecordType datasetType, ARecordType metaType,
        ...
        int writersOffset = offset + UnsafeUtil.getInt(bytes, offset + WRITERS_POINTER);
    ...
    public List<AbstractColumnTupleReference> getComponentsTuples() {
