...
public abstract class AbstractCollectionSchemaNode extends AbstractSchemaNestedNode {
    ...
    public final AbstractSchemaNode getOrCreateItem(ATypeTag childTypeTag, FlushColumnMetadata context)
            throws HyracksDataException {
        AbstractSchemaNode newItem = context.getOrCreateChild(item, childTypeTag);
        if (newItem != item) {
            item = newItem;
        }
        return item;
