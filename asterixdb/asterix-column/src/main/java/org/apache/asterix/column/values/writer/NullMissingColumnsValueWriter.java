...
public class NullMissingColumnsValueWriter extends AbstractColumnValuesWriter {
    private static final BytesInput EMPTY = BytesInput.empty();
    private final RunLengthIntArray defLevelsIntArray;

    NullMissingColumnsValueWriter(int columnIndex, int level, boolean collection, boolean filtered) {
