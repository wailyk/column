...
public class QueryColumnTupleProjectorFactory implements ITupleProjectorFactory {
    ...
    public ITupleProjector createTupleProjector(IHyracksTaskContext context) {
        ...
        if (requestedMetaType == null
                || DataProjectionInfo.EMPTY_TYPE.getTypeName().equals(requestedMetaType.getTypeName())) {
            /*
        ...
        return new QueryColumnWithMetaTupleProjector(datasetType, metaType, numberOfPrimaryKeys, requestedType,
                functionCallInfo, requestedMetaType, metaFunctionCallInfo, warningCollector);
    }
}
