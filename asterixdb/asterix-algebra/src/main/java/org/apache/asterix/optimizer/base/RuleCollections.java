...
import org.apache.asterix.optimizer.rules.ReplaceFieldAccessOnRecordConstructorRule;
...
import org.apache.asterix.optimizer.rules.codegen.PlanToCodeGenRule;
...
public final class RuleCollections {
    ...
    public static final List<IAlgebraicRewriteRule> buildPhysicalRewritesAllLevelsRuleCollection() {
        ...
        physicalRewritesAllLevels.add(new ReplaceFieldAccessOnRecordConstructorRule());
    ...
    public static final List<IAlgebraicRewriteRule> buildPhysicalRewritesTopLevelRuleCollection(
        ...
        physicalRewritesTopLevel.add(new PlanToCodeGenRule());
        physicalRewritesTopLevel.add(new SetAsterixPhysicalOperatorsRule());
        //Set deliveredPhysicalProperties for the newly introduced project
        physicalRewritesTopLevel.add(new EnforceStructuralPropertiesRule(BuiltinFunctions.RANGE_MAP,
                BuiltinFunctions.LOCAL_SAMPLING, BuiltinFunctions.NULL_WRITER));
