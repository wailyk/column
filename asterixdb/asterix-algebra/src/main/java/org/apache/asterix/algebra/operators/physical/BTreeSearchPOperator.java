...
public class BTreeSearchPOperator extends IndexSearchPOperator {
    ...
    public void contributeRuntimeOperator(IHyracksJobBuilder builder, JobGenContext context, ILogicalOperator op,
        ...
        switch (unnestMap.getOperatorTag()) {
            case UNNEST_MAP:
                ...
                if (isPrimaryIndex && formatInfo.getFormat() == DatasetFormat.COLUMN) {
                    IProjectionInfo<?> projectionInfo = unnestMapOp.getDatasetProjectionInfo();
                    IProjectionInfo<?> metaProjectionInfo = unnestMapOp.getMetaProjectionInfo();
        ...
        boolean isColumn = dataset.getDatasetFormatInfo().getFormat() == DatasetFormat.COLUMN;
        Pair<IOperatorDescriptor, AlgebricksPartitionConstraint> btreeSearch = metadataProvider.buildBtreeRuntime(
                ...
                unnestMap.getGenerateCallBackProceedResultVar(), isPrimaryIndexPointSearch(op, isColumn),
                tupleProjectorFactory, null);
    ...
    private boolean isPrimaryIndexPointSearch(ILogicalOperator op, boolean isColumn) {
