...
public class ModScalarOperatorCodeNode extends AbstractArithmeticOperatorCodeNode {
    private static final long serialVersionUID = -2668196630745277617L;
    public static final String OPERATOR = "%";

    public ModScalarOperatorCodeNode(SourceLocation sourceLocation, ICodeNode left, ICodeNode right) {
