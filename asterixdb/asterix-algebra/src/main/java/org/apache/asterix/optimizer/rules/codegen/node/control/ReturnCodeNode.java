...
public class ReturnCodeNode extends AbstractCodeNode {
    private static final long serialVersionUID = -5849480171258063293L;
    private final ICodeNode returnExpression;

    public ReturnCodeNode(ICodeNode returnExpression) {
    ...
    public ICodeNode getReturnExpression() {
