...
public class WhileCodeNode extends AbstractCodeNode {
    private static final long serialVersionUID = -5540531057157904546L;

    private final ICodeNode condition;
    private final BlockCodeNode loopBlock;

    public WhileCodeNode(ICodeNode condition, BlockCodeNode loopBlock) {
        this(GENERATED_LOCATION, condition, loopBlock);
    }

    public WhileCodeNode(SourceLocation sourceLocation, ICodeNode condition, BlockCodeNode loopBlock) {
    ...
    public BlockCodeNode getLoopBlock() {
        return loopBlock;
    }
