...
public interface IExpectedSchemaNode {
     ...
     * @param functionIdentifier function name as in {@link FunctionIdentifier#getName()}
     * @see AbstractComplexExpectedSchemaNode#replaceIfNeeded(ExpectedSchemaNodeType, SourceLocation, FunctionIdentifier)
     * @see UnionExpectedSchemaNode#replaceIfNeeded(ExpectedSchemaNodeType, SourceLocation, FunctionIdentifier)
     */
