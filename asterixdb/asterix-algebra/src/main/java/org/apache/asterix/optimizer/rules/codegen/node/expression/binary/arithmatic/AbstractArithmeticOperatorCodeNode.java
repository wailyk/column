...
public abstract class AbstractArithmeticOperatorCodeNode extends AbstractBinaryCodeNode {
    private static final long serialVersionUID = -733790020111219724L;

    protected AbstractArithmeticOperatorCodeNode(SourceLocation sourceLocation, ICodeNode left, ICodeNode right) {
        super(sourceLocation, left, right);
    }

    @Override
    public CodeNodeType getType() {
        return CodeNodeType.BINARY_ARITHMETIC;
    }
}
