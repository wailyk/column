...
public class StringLengthBuiltinNode extends AbstractBuiltinFunction {
    private static final long serialVersionUID = -7635100797874331207L;
    public static final ICodeNodeBuiltinFunctionFactory FACTORY = StringLengthBuiltinNode::new;

    private StringLengthBuiltinNode(SourceLocation sourceLocation, ICodeNode... args) {
        super(sourceLocation, args);
    }

    @Override
    protected String getRawName() {
        return BuiltinFunctions.STRING_LENGTH.getName();
    }
}
