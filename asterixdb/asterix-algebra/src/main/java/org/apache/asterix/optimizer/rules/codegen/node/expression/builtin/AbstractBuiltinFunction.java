...
public abstract class AbstractBuiltinFunction extends AbstractCodeNode {
    private static final long serialVersionUID = 8934974160859798583L;
    private final ICodeNode[] args;

    protected AbstractBuiltinFunction(SourceLocation sourceLocation, ICodeNode... args) {
    ...
    public final ICodeNode[] getArgs() {
        return args;
    }

    @Override
    public final CodeNodeType getType() {
        return CodeNodeType.EXPRESSION;
    }

    public final String getFunctionName() {
        return toUnderScore(getRawName());
    }
