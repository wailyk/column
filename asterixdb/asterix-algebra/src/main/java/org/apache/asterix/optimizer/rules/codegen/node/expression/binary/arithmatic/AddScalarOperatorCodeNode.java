...
public class AddScalarOperatorCodeNode extends AbstractArithmeticOperatorCodeNode {
    private static final long serialVersionUID = -2668196630745277617L;
    public static final String OPERATOR = "+";

    public AddScalarOperatorCodeNode(SourceLocation sourceLocation, ICodeNode left, ICodeNode right) {
        super(sourceLocation, left, right);
    }

    public AddScalarOperatorCodeNode(ICodeNode left, ICodeNode right) {
