...
public class CompilerProperties extends AbstractProperties {
    ...
    public enum Option implements IOption {
        ...
        COMPILER_CODEGEN(BOOLEAN, AlgebricksConfig.CODE_GEN_DEFAULT, "Enable/disable query code generation");
    ...
    public static final String COMPILER_CODEGEN_KEY = Option.COMPILER_CODEGEN.ini();
    ...
    public boolean isCodeGen() {
        return accessor.getBoolean(Option.COMPILER_CODEGEN);
    }
}
