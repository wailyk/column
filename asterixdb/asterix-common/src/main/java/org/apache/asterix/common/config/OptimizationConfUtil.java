...
public class OptimizationConfUtil {
    ...
    public static PhysicalOptimizationConfig createPhysicalOptimizationConf(CompilerProperties compilerProperties,
        ...
        boolean codeGen = getBoolean(querySpecificConfig, CompilerProperties.COMPILER_CODEGEN_KEY,
                compilerProperties.isCodeGen());
        ...
        physOptConf.setCodeGenEnabled(codeGen);
        return physOptConf;
    }
