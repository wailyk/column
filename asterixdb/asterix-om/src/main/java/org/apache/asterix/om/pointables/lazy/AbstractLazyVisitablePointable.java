 ...
 * {@link IVisitablePointable#set(byte[], int, int)} and another pass is done by the processor {@link
 * ILazyVisitablePointableVisitor}. Also, the lazy visitable-pointable requires less memory as we do not allocate any
 * temporary buffers.
 */
