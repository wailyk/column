...
public class TypeComputeUtils {
     ...
     * @param checker,                 the argument type checker.
     * @param resultTypeGenerator,     the result type generator.
     * @param propagateNullAndMissing, whether the expression follows MISSING/NULL-in-MISSING/NULL-out semantics.
    ...
    public static IAType getActualType(IAType inputType) {
        if (inputType == null) {
            System.err.println("fdsllfkjksldfj");
        }
